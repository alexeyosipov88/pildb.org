...
inapplicable to their frontier traffic or to authorize the use in transport
...
Convention shall nevertheless apply to the whole of the carriage. Provided that
to the extent it is proved that any loss, damage or delay in delivery of the
goods which occurs during the carriage by the other means of transport was not
caused by act or omission of the carrier by road, but by some event which could
only occurred in the course of and by reason of the carriage by that other
...
the carriage the goods alone had been made by the sender with the carrier by
the other means of transport in accordance with the conditions prescribed by
law for the carriage of goods by that means of transport. If, however, there
are no such prescribed conditions, the liability of the carrier by road shall
...
provisions paragraph 1 of this article, but as if, in his capacities as carrier
...
consignment note has been made out so permits. The first copy shall be handed
to the sender, the second shall accompany the goods and the third shall be
retained by the carrier.
2. When the goods which are to be carried have to be loaded in different
vehicles, or are of different kinds or are divided into different lots, the
...
consignment note to be made out or for the purpose of their being entered
therein.
2. If, at the request of the sender, the carrier enters in the consignment note
the particulars referred to in paragraph 1 of this article, he shall be deemed,
unless the contrary is proved, to have done so on behalf of the sender.
3. If the consignment note does not contain the statement specified in article
6, paragraph 1 (k), the carrier shall be liable for all expenses, loss and
...
2. Where the carrier has no reasonable means of checking the accuracy of e
...
are based. He shall likewise specify the grounds for any reservations which he
makes with regard to the apparent condition of the goods and their packaging,
such reservations shall not bind the sender unless he has expressly agreed to
be bound by them in the consignment note.
3. The sender shall be entitled to require the carrier to check the gross
weight the goods or their quantity otherwise expressed. He may also require the
...
2. If the consignment note contains no specific reservations by the carrier, it
shall be presumed, unless the contrary is proved, that the goods and their
packaging appeared to be in good condition when the carrier took them over and
...
and shall furnish him with all the information which he requires.
2. The carrier shall not be under any duty to enquire into either the accuracy
or the adequacy of such documents and information. The sender shall be liable
to the carrier for any damage caused by the absence, inadequacy or irregularity
of such documents and information, except in the case of some wrongful act or
...
note or deposited with the carrier shall be that of an agent, provided that the
...
consignee indicated in the consignment note.
2. This right shall cease to exist when the second copy of the consignment note
is handed to the consignee or when the consignee exercises his right under
article 13, paragraph 1; from that time onwards the carrier shall obey the
orders of the consignee.
3. The consignee shall, however, have the right of disposal from the time when
the consignment note is drawn up, if the sender makes an entry to that effect
...
conditions:
(a) That the sender or, in the case referred to in paragraph 3 of this article,
the consignee who wishes to exercise the right produces the first copy of the
consignment note on which the new instructions to the carrier have been entered
and indemnifies the carrier against all expenses, loss and damage involved in
...
interfere with the normal working of the carriers'' undertaking or prejudice the
senders or consignees of other consignments;
(c) That the instructions do not result in a division of the consignment.
6. When, by reason of the provisions of paragraph 5 (b) of this article, the
carrier cannot carry out the instructions which he receives, he shall
immediately notify the person who gave him such instructions.
7. A carrier who has not carried out the instructions given under the
conditions provided for in this article or who has carried them out without
requiring the first copy of the consignment note to be produced, shall be
...
the goods established or if the goods have not arrived after the expiry of the
period provided for in article 19, the consignee shall be entitled to enforce
in his own name against the carrier any rights arising from the contract of
carriage.
...
consignment note, but in the event of dispute on this matter the carrier shall
...
from the person entitled to dispose of the goods in accordance with the
provisions of article 12.
2. Nevertheless, if circumstances are such as to allow the carriage to be
carried out under conditions differing from those laid down in the consignment
note and if the carrier has been unable to obtain instructions in reasonable
time the person entitled to dispose of the goods in accordance with the
...
to dispose of them without being obliged to produce the first copy of the
consignment note.
2. Even if he has refused the goods, the consignee may nevertheless require
delivery so long as the carrier has not received instructions to the contrary
from the sender.
3. When circumstances preventing delivery of the goods arise after the
consignee, in exercise of his rights under article 12, paragraph 3, has given
an order for the goods to be delivered to another person, paragraphs 1 and 2 of
...
2. In the cases referred to in article 14, paragraph 1, and in article 15, the
carrier may immediately unload the goods for account of the person entitled to
dispose of them and thereupon the carriage shall be deemed to be at an end. The
carrier shall then hold the goods on behalf of the person so entitled. He may,
however, entrust them to a third party, and in that case he shall not be under
any liability except for the exercise of reasonable care in the choice of such
third party. The charges due under the consignment note and all other expenses
shall remain chargeable against the goods.
3. The carrier may sell the goods, without awaiting instructions from the
person entitled to dispose of them, if the goods are perishable or their
...
4. If the goods have been sold pursuant to this article, the proceeds of sale,
after deduction of the expenses chargeable against the goods, shall be placed
at the disposal of the person entitled to dispose of the goods. If these
...
reason of the wrongful act or neglect of the person from whom he may have hired
...
(b) The lack of, or defective condition of packing in the case of goods which,
...
(d) The nature of certain kinds of goods which particularly exposes them to
total or partial loss or to damage, especially through breakage, rust, decay,
...
some of the factors causing the loss, damage or delay, he shall only be liable
...
damage could be attributed to one or more of the special risks referred to in
article 17, paragraph 4, it shall be presumed that it was so caused. The
...
paragraph 4 (a), if there has been an abnormal shortage, or a loss of any
package.
...
of the air, the carrier shall not be entitled to claim the benefit of article
17, paragraph 4 (d), unless he proves that all steps incumbent on him in the
circumstances with respect to the choice, maintenance and use of such equipment
...
particular, in the case of partial loads, the time required for making up a
...
2. The person so entitled may, on receipt of compensation for the missing
goods, request in writing that he shall be notified immediately should the
goods be recovered in the course of the year following the payment of
compensation. He shall be given a written acknowledgement of such request.
3. Within the thirty days following receipt of such notification, the person
entitled as aforesaid may require the goods to be delivered to him against
payment of the charges shown to be due on the consignment note and also against
refund of the compensation he received less any charges included therein but
without prejudice to any claims to compensation for delay in delivery under
article 23 and where applicable, article 26.
...
or if the goods are not recovered until more than one year after the payment of
...
knew the exact nature of the danger constituted by the carriage of the said
goods shall rest upon the sender or the consignee.
2. Goods of a dangerous nature which, in the circumstance referred to in
paragraph 1 of this article, the carrier did not know were dangerous, may, at
any time or place, be unloaded, destroyed or rendered harmless by the carrier
without compensation; further, the sender shall be liable for all expenses,
...
price or, if there is no such price, according to the current market price or,
if there is no commodity exchange price or current market price, by reference
to normal value of goods of the same kind and quality.
3. Compensation shall not, however, exceed 8.33 units of account per kilogram
of gross weight short.
4. In addition, the carriage charges, Customs duties and other charges incurred
in respect of the carriage of the goods shall be refunded in full in case of
total loss and in proportion to the loss sustained in case of partial loss, but
no further damage shall be payable.
...
and 26.
7. The unit of account mentioned in this Convention is the Special Drawing
Right as defined by the International Monetary Fund. The amount mentioned in
paragraph 3 of this article shall be converted into the national currency of
the State of the Court seized of the case on the basis of the value of that
currency on the date of the judgment or the date agreed upon by the Parties.
...
Fund, shall be calculated in a manner determined by the State.
8. Nevertheless, a State which is not a member of the International Monetary
Fund and whose law does not permit the application of the provisions of
paragraph 7 of this article may, at the time of ratification of or accession to
the Protocol to the CMR or at any time thereafter, declare that the limit of
liability provided for in paragraph 3 of this article to be applied in its
territory shall be 25 monetary units. The monetary unit referred to in this
paragraph corresponds to the 10/31 gram of gold of millesimal fineness nine
hundred. The conversion shall be made according to the law of the State
concerned.
9. The calculation mentioned in the last sentence of paragraph 7 of this
article and the conversion mentioned in paragraph 8 of this article shall be
made in such a manner as to express in the national currency of the State as
far as possible the same real value for the amount in paragraph 3 of this
article as is expressed there in units of account. States shall communicate to
the Secretary-General of the United Nations the manner of calculation pursuant
to paragraph 7 of this article or the result of the conversion in paragraph 8
of this article as the case may be, when depositing an instrument referred to
in Article 3 of the Protocol to the CMR and whenever there is a change in
either.
ARTICLE 24
----------
...
compensation for the additional loss or damage proved may be claimed, up to the
...
has been made, from the date on which legal proceedings were instituted.
2. When the amounts on which the calculation of the compensation is based are
not expressed in the currency of the country in which payment is claimed,
...
2. In cases where the extra-contractual liability for loss, damage or delay of
one of the persons for whom the carrier is responsible under the terms of
article 3 is in issue, such person may also avail himself of the provisions of
...
part as, in accordance with the law of the court or tribunal seised of the
...
committed by the agents or servants of the carrier or by any other persons of
...
case of apparent loss or damage and within seven days of delivery, Sundays and
public holidays excepted, in the case of loss or damage which is not apparent,
the fact of this taking delivery shall be prima facie, evidence that he has
received the goods in the condition described in the consignment note. In the
case of loss or damage which is not apparent the reservations referred to shall
be made in writing.
2. When the condition of the goods has been duly checked by the consignee and
the carrier, evidence contradicting the result of this checking shall only be
admissible in the case of loss or damage which is not apparent and provided
that the consignee has duly sent reservations in writing to the carrier within
...
has been sent in writing to the carrier, within twenty-one days from the time
that the goods were placed at the disposal of the consignee.
4. In calculating the time-limits provided for in this article the date of
delivery, or the date of checking, or the date when the goods were placed at
the disposal of the consignee, as the case may be, shall not be included.
...
place designated for delivery is situated. 2. Where in respect of a claim
referred to in paragraph 1 of this article an action is pending before a court
or tribunal competent under that paragraph, or where in respect of such a claim
a judgement has been entered by such a court or tribunal no new action shall be
started between the same parties on the same grounds unless the judgement of
the court or tribunal before which the first action was brought is not
...
4. The provisions of paragraph 3 of this article shall apply to judgements
after trial, judgements by default and settlements confirmed by an order of the
court, but shall not apply to interim judgements or to awards of damages, in
addition to costs against a plaintiff who wholly or partly fails in his action.
5. Security for costs shall not be required in proceedings arising out of
...
of the case, is considered as equivalent to wilful misconduct, the period of
limitation shall be three years. The period of limitation shall begin to run:
(a) In the case of partial loss, damage or delay in delivery, from the date of
delivery;
(b) In the case of total loss, from the thirtieth day after the expiry of the
agreed time-limit or where there is no agreed time-limit from the sixtieth day
from the date on which the goods were taken over by the carrier;
(c) In all other cases, on the expiry of a period of three months after the
making of the contract of carriage.
The day on which the period of limitation begins to run shall not be included
in the period.
2. A written claim shall suspend the period of limitation until such date as
the carrier rejects the claim by notification in writing and returns the
documents attached thereto. If a part of the claim is admitted the period of
limitation shall start to run again only in respect of that part of the claim
still in dispute. The burden of proof of the receipt of the claim, or of the
reply and of the return of the documents, shall rest with the party relying
upon these facts. The running of the period of limitation shall not be
suspended by further claims having the same object.
3. Subject to the provisions of paragraph 2 above, the extension of the period
of limitation shall be governed by the law of the court or tribunal seized of
the case. That law shall also govern the fresh accrual of rights of action.
...
copy of the consignment note and on the receipt reservations of the kind
...
from the other carriers who have taken part in the carriage, subject to the
following provisions:
(a) The carrier responsible for the loss or damage shall be solely liable for
the compensation whether paid by himself or by another carrier;
...
liability; should it be impossible to apportion the liability, each carrier
shall be liable in proportion to the share of the payment for the carriage
which is due to him;
(c) If it cannot be ascertained to which carriers liability is attributable for
...
after the first mentioned carrier had been given due notice of the proceedings
and afforded an opportunity of entering an appearance.
2. A carrier wishing to take proceedings to enforce his right of recovery may
make his claim before the competent court or tribunal of the country in which
one of the carriers concerned is ordinarily resident, or has his principal
place of business or the branch or agency through which the contract of
carriage was made. All the carriers concerned may be made defendants in the
same action.
3. The provisions of article 31, paragraphs 3 and 4, shall apply to judgements
entered in the proceedings referred to in articles 37 and 38.
4. The provisions of article 32 shall apply to claims between carriers. The
period of limitation shall, however, begin to run either on the date of the
...
of reference may become Contracting Parties to this Convention by acceding
...
deposited their instruments of ratification of accession, this Convention shall
...
all or any of the territories for the international relations of which it is
responsible. The Convention shall extend to the territory or territories named
in the notification as from the ninetieth day after its receipt by the
Secretary-General or, if on that day the Convention has not yet entered into
...
article 47 in respect of any Contracting Party which has entered such a
reservation.
...
Convention. The Secretary-General shall notify all Contracting Parties of the
request and a review conference shall be convened by the Secretary-General if,
within a period of four months following the date of notification by the
Secretary General, not less than one-fourth of the Contracting Parties notify
...
submit within a period of three months such proposals as they may wish the
...
texts of such proposals at least three months before the date on which the
