...
(e) all necessary specifications concerning transportation, accommodation as well as all ancillary services included in he price;
...
2. A breach by the travel intermediary of the obligations incumbent upon him under Article 18 shall affect neither the existence nor the validity of the contract which shall remain subject to this Convention. In the event of a breach of his obligations under Article 18, paragraph 1, the travel intermediary shall be deemed to be a travel organizer. In the event of a breach of his obligations under Article 18, paragraph 2, the travel intermediary shall be liable for any loss or damage resulting from such breach.
...
ON THE TRAVEL CONTRACT
 
Resolution
The work completed, the Diplomatic Conference on the Travel Contract wishes to present its most sincere appreciation to the International Institute for the Unification of Private Law (UNIDROIT) which prepared, following long and detailed studies, the draft International Convention on the Travel Agency Contract utilized as basic working paper at the Conference.
 
Recommendation no. 1
The Conference recommends that the Contracting States take appropriate measures in order to ensure that travel organizers and travel intermediaries be able to meet the financial obligations incumbent upon them under the Convention.
 
Recommendation no. 2
Each Contracting State is requested to help the International Institute for the Unification of Private Law (UNIDROIT) in compiling, each year, a list in the English and French languages, of judicial and arbitral decisions of major importance relating to the interpretation and application of the International Convention on the Travel Contract. In this list, there shall be a short summary of the contents of each decision and a reference to the source where the decision is to be found. This material will be edited by UNIDROIT in a publication which will be sent to each Contracting State.
 
Recommendation no. 3
The Diplomatic Conference on the Travel Contract (CCV) meeting in Brussels in 1970,
Having noted that during the Convention drafting procedure, the insufficiency if not the total lack of uniform international rules governing the hotelkeepers'' liability was stressed,
Having taken into consideration the fact that the International Institute for Unification of Private Law (UNIDROIT) had already elaborated a draft uniform law on hotelkeepers'' liability, with respect to personal belongings brought by travellers, draft that was used as a basis for the European Convention in this field, the general elaboration of the uniform provisions on the hotelkeepers'' contract, appears in the UNIDROIT work programme,
Expresses the wish that the International Institute for the Unification of Private Law (UNIDROIT), will undertake as soon as possible, the elaboration of uniform provisions relative to hotelkeepers'' contracts, to be subsequently submitted to the Governments for examination and eventual approval.
')