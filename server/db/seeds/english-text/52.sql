...
container, pallet or similarArticle of transport or where they are packed,
"goods" includes suchArticle of transport or packaging if supplied by the
shipper.
...
2. For the purpose of paragraph 1 of thisArticle, the carrier is deemed to be
...
must be handed over.
3. In paragraphs 1 and 2 of thisArticle, reference to the carrier or to the
...
inArticle 4, unless the carrier proves that he, his servants or agents took all
...
paragraph 2 of thisArticle.
4. (a) The carrier is liable
(i) For loss or damage to the goods or delay in delivery caused by fire, if the
...
to have resulted from the fault or neglect of the carrier, his servants or
agents, in taking all measures that could reasonably be required to put out the
fire and avoid or mitigate its consequences.
(b) In case of fire on board the ship affecting the goods, if the claimant or
the carrier so desires, a survey in accordance with shipment practices must be
held into the cause and circumstances of the fire, and a copy of the surveyor''s
...
carrier is liable only to the extent that the loss, damage or delay in delivery
...
provisions ofArticle 5 is limited to an amount equivalent to two and a half
times the freight payable for the goods delayed, but no exceeding the total
...
paragraph 1 (a) of thisArticle, the following rules apply:
(a) Where a container, pallet or similarArticle of transport is used to
...
contract of carriage by sea, as packed in suchArticle of transport are deemed
packages or shipping units. Except as aforesaid the goods in suchArticle of
transport are deemed one shipping unit.
(b) In cases where theArticle of transport itself has been lost or damaged,
thatArticle of transport, if not owned or otherwise supplied by the carrier, is
...
3. Except as provided inArticle 8, the aggregate of the amounts recoverable
...
2. Notwithstanding the provisions of paragraph 2 ofArticle 7, a servant or
agent of the carrier is not entitled to the benefit of the limitation of
liability provided for inArticle 6 if it is proved that the loss, damage or
...
In the absence of such statement the carrier has the burden of proving that an
...
paragraph 1 of thisArticle or where the carrier may not under paragraph 2 of
thisArticle invoke an agreement for carriage on deck, the carrier,
...
in accordance with the provisions ofArticle 6 orArticle 8 of this Convention,
as the case may be.
...
the entire carriage according to the provisions of this Convention. The carrier
is responsible, in relation to the carriage performed by the actual carrier,
for the acts and omissions of the actual carrier and of his servants and agents
...
performed by him. The provisions of paragraphs 2 and 3 ofArticle 7 and of
paragraph 2 ofArticle 8 apply if an action is brought against a servant or
...
the carrier, the contract may also provide that the carrier is not liable for
loss, damage or delay in delivery caused by an occurrence which takes place
while the goods are in the charge of the actual carrier during such part of the
carriage. Nevertheless, any stipulation limiting or excluding such liability is
without effect if no judicial proceedings can be instituted against the actual
carrier in a court competent under paragraph 1 or 2 of article 21. The burden
of proving that any loss, damage or delay in delivery has been caused by such
...
3. The provisions of paragraph 2 of thisArticle may not be invoked by any
...
thisArticle do not apply or may not be invoked, dangerous goods become an
...
to the particulars required under paragraph 1 of thisArticle, must state that
the goods are on board a named ship or ships, and the date or dates of loading.
If the carrier has previously issued to the shipper a bill of lading or other
...
thisArticle does not affect the legal character of the document as a bill of
...
reservation permitted under paragraph 1 of thisArticle has been entered:
...
(h) ofArticle 15, set forth the freight or otherwise indicate that freight is
...
such demurrage is payable by him. However, proof to the contrary by the carrier
is not admissible when the bill of lading has been transferred to a third
...
referred to in paragraph 2 of thisArticle, intends to defraud a third party,
...
particulars furnished by the shipper for insertion in the bill of lading, the
...
carrier is liable, without the benefit of the limitation of liability provided
...
thisArticle apply correspondingly if notice in writing is not given within 15
...
has been the subject of a joint survey or inspection by the parties, notice in
writing need not be given of loss or damage ascertained during such survey or
inspection.
...
under thisArticle to him shall have the same effect as if it had been given to
...
or after the delivery of the goods in accordance with paragraph 2 ofArticle 4,
whichever is later, the failure to give such notice is prima facie evidence
...
8. For the purpose of thisArticle, notice given to a person acting on the
carrier''s or the actual carriers'' behalf, including the master or the officer
...
proceedings are instituted. However, the time allowed shall not be less than 90
days commencing from the day when the person instituting such action for
...
(b) The place where the contract was made provided that the defendant has there
...
carriage by sea.
2. (a) Notwithstanding the preceding provisions of thisArticle, an action may
...
jurisdictions referred to in paragraph 1 of thisArticle for the determination
...
may be instituted in a place not specified in paragraph 1 or 2 of thisArticle.
...
i or 2 of thisArticle or where judgement has been delivered by such a court, no
new action may be started between the same parties on the same grounds unless
the judgement of the court before which the first action instituted is not
enforceable in the country in which the new proceedings are instituted.
(b) For the purpose of thisArticle the institution of measures with a view to
obtaining enforcement of a judgement is not to be considered as the starting of
a new action;
(c) For the purpose of thisArticle, the removal of an action to a different
court within the same country, or to a court in another country, in accordance
with paragraph 2 (a) of thisArticle, is not to be considered as the starting of
a new action.
...
charterparty does not contain a special annotation providing that such
...
Convention.
5. The provisions of paragraph 3 and 4 of thisArticle are deemed to be part of
...
6. Nothing in thisArticle affects the validity of an agreement relating to
...
of the other provisions of the contract or document of which it forms a part. A
clause assigning benefit of insurance of the goods in favour of the carrier, or
any similar clause, is null and void.
2. Notwithstanding the provisions of paragraph 1 of thisArticle, a carrier may
...
a stipulation which is null and void by virtue of the presentArticle, or as a
result of the omission of the statement referred to in paragraph 3 of
thisArticle, the carrier must pay compensation to the extent required in order
...
the claimant for the purpose of exercising his right, provided that costs
...
general average.
2. With the exception ofArticle 20, the provisions of this Convention relating
to the liability of the carrier for loss of or damage to the goods also
determine whether the consignee may refuse contribution in general average and
...
in the saidArticles, provided that the dispute arises exclusively between
...
paragraph 4 ofArticle 22 of this Convention.
...
4. No liability that arise under the provisions of this Convention for any loss
of or damage to or delay in delivery of luggage for which the carrier is
...
a State according to the value of such currency at the date of judgement or the
date agreed upon by the parties. The value of a national currency, in terms of
the Special Drawing Right, of a Contracting State which is a member of the
...
in question for its operations and transactions. The value of a national
currency in terms of the Special Drawing Right of a Contracting State which is
not a member of the International Monetary Fund is to be calculated in a manner
...
of paragraph i of thisArticle may, at the time of signature, or at the time of
...
applied in their territories shall be fixed as: 12,500 monetary units per
package or other shipping unit or 37.5 monetary units per kilogram of gross
weight of the goods.
3. The monetary unit referred to in paragraph 2 of thisArticle corresponds to
...
4. The calculation mentioned in the last sentence of paragraph I and the
conversion mentioned in paragraph 3 of thisArticle is to be made in such a
manner as to express in the national currency of the Contracting State as far
as possible the same real value for the amounts inArticle 6 as is expressed
there in units of account. Contracting States must communicate to the
depositary the manner of calculation pursuant to paragraph 1 of thisArticle, or
the result of the conversion mentioned in paragraph 3 of thisArticle, as the
...
the date of the deposit of the 20th instrument of ratification, acceptance,
...
30, the depositary of this Convention must notify the Government of Belgium as
...
entered into force.
3. The provisions of paragraphs 1 and 2 of thisArticle apply correspondingly in
...
4. NotwithstandingArticle 2 of this Convention, for the purposes of paragraph 1
of thisArticle, a Contracting State may, if it deems it desirable, defer the
denunciation of the 1924 Convention and of the 1924 Convention as modified by
the 1968 Protocol for a maximum period of five years from the entry into force
of this Convention. It will then notify the Government of Belgium of its
...
3 ofArticle 26 by other units is to be convened by the depositary in accordance
...
2. A revision conference is to be convened by the depositary when not less than
one-fourth of the Contracting States so request.
3. Any decision by the conference must be taken by a two-thirds majority of the
participating States. The amendment is communicated by the depositary to all
the Contracting States for acceptance and to all the States signatories of the
...
In witness whereof the undersigned plenipotentiaries, being duly authorised by
...
Resolution adopted by the United Nations Conference on the Carriage of Goods by
Sea (A/CON.89/13, annex III)
The United Nations Conference on the Carriage of Goods by Sea,
Noting with appreciation the kind invitation of the Federal Republic of Germany
to hold the Conference in Hamburg,
Being aware that the facilities placed at the disposal of the Conference and
the generous hospitality bestowed on the participants by the Government of the
Federal Republic of Germany and by the Free and Hanseatic City of Hamburg, have
in no small measure contributed to the success of the Conference.
Expresses its gratitude to the Government and people of the Federal Republic of
Germany, and
Having adopted the Convention on the Carriage of Goods by Sea on the basis of a
draft Convention prepared by the United Nations Commission on International
Trade Law at the request of the United Nations Conference on Trade and
Development,
Expresses its gratitude to the United Nations Commission on International Trade
Law and to the United Nations Conference on Trade and Development for their
outstanding contribution to the simplification and harmonisation of the law of
the carriage of goods by sea, and
Decides to designate the Convention adopted by the Conference as the: "UNITED
NATIONS CONVENTION ON THE CARRIAGE OF GOODS BY SEA, 1978", and
')