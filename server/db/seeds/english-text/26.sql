...
d) agency by virtue of a decision of a judicial or quasi-judicial authority or subject to the direct control of such an authority;
...
Article 5
The internal law chosen by the principal and the agent shall govern the agency relationship between them.
This choice must be express or must be such that it may be inferred with reasonable certainty from the terms of the agreement between the parties and the circumstances of the case.
Article 6
...
e) clientele allowances (l''indemnit? de client?le);
